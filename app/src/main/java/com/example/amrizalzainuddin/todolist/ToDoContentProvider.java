...
public class ToDoContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.example.amrizalzainuddin.todoprovider/todoitems");
    ...
    //correspond to a request for all items, and 'todoitems/[rowID]' represents a single row
    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI("com.example.amrizalzainuddin.todoprovider", "todoitems", ALLROWS);
        uriMatcher.addURI("com.example.amrizalzainuddin.todoprovider", "todoitems/#", SINGLE_ROW);
    }
    ...
    public String getType(Uri uri) {
        //returns a string that identifies the MIME type
        switch (uriMatcher.match(uri)){
            case ALLROWS: return "vnd.android.cursor.dir/vnd.paad.todo";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //to add empty rows to your database by passing in an empty Content Value
        //object, you must use the null column hack parameter to specify the name of
        //the column tha can be set to null
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        //to return the number of deleted items, you must specify the where
